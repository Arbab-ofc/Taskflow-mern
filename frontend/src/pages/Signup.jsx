...
const Signup = () => {
  ...
  return (
    <AuthLayout
      ...
      title="Set up your TaskFlow workspace"
      subtitle="Create an account to keep task ownership, updates, and trash recovery tied to your team."
      sideTitle="What you get"
      sideCopy="A protected dashboard, task details, and management tools that stay synced to your own data."
    >
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <h2 className="mt-4 text-2xl font-semibold tracking-tight text-slate-950 dark:text-white">Sign up</h2>
          <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-300">
            Add your details once and start tracking tasks immediately.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 border-t border-slate-200 pt-5 sm:flex-row sm:items-center sm:justify-between dark:border-white/10">
          ...
          <div className="text-center sm:text-right">
            <p className="text-sm text-slate-500">Already using TaskFlow?</p>
            <Link
